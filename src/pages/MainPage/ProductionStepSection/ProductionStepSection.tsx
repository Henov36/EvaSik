		...
		<ProdSectionStyles>
			<Container>
				...
				<div className="cards__container">
					<ProductionStep img={FirstStep} text={t("productionSteps.step1")} />
					<ProductionStep img={second} text={t("productionSteps.step2")} />
					<ProductionStep img={third} text={t("productionSteps.step3")} />
					<ProductionStep img={four} text={t("productionSteps.step4")} />
					<ProductionStep img={five} text={t("productionSteps.step5")} />
					<ProductionStep img={six} text={t("productionSteps.step6")} />
					<ProductionStep img={seven} text={t("productionSteps.step7")} />
				</div>
			</Container>
		</ProdSectionStyles>
	);
