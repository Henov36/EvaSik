...
/**
 * Единая сетка каталога с фильтрами по "родине смаку" (яблучні/виноградні/
 * ягідні/...) — используется на страницах glass/box/tea вместо прежнего
 * простого ProductsList. Категории фильтра берутся из фактических товаров
 * переданного списка, а не заданы статично, так что пункт "Овочеві"
 * появится сам, только если в категории реально есть томатно-морквяний сік.
 */
